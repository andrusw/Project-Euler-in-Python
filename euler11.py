...
for row in range(0,20):
    for col in range(0,20):
        ...
        if col < 17:
            curH = grid[row][col] * grid[row][col+1] * grid[row][col+2] * grid[row][col+3]
        if row < 17:
            curV = grid[row][col] * grid[row+1][col] * grid[row+2][col] * grid[row+3][col]
        if col < 17 and row < 17:
            cur_dr = grid[row][col] * grid[row+1][col+1] * grid[row+2][col+2] * grid[row+3][col+3]
        if col > 2 and row < 17:
            cur_dl = grid[row][col] * grid[row+1][col-1] * grid[row+2][col-2] * grid[row+3][col-3]
